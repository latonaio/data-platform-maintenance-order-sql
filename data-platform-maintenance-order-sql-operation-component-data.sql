CREATE TABLE `data_platform_maintenance_order_operation_component_data`
(
  ...
  `ExpectedOverallLimitAmount`        varchar(13) DEFAULT NULL,
    ...
    CONSTRAINT `DB_MaintenanceOrderOperationComponentData_fk` FOREIGN KEY (`MaintenanceOrder`) REFERENCES `data_platform_maintenance_order_header_data` (`MaintenanceOrder`)
) ENGINE = InnoDB
